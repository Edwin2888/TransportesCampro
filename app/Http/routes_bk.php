...
//    dd($lideresNombres);
    ...
    $ruta_imagenes = 'http://201.217.195.43/ssl/{{$otros[0]->prefijo}}/FORMULARIOS';
    if($datos_ssl[0]->prefijo === 'sct') {
        $ruta_imagenes = 'http://190.60.248.195/fotos/sct/ssl/FORMULARIOS';
    }
    ...
    return $pdf->download('IRO_ORDEN_'.$orden.'.pdf');

...
Route::get('transporte/costos/arrendamientos/{pre?}',"Transporte\ControllerArrendamiento@consulta");
...
Route::get('transversal/supervision/plansupervision/{dato?}','Supervision\ControllerPlanSupervision@index');

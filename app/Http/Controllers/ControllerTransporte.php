...
class ControllerTransporte extends Controller
{
        ...
        $documentosV =
            DB::connection('sqlsrvCxParque')
                ...
                ->select('tbl1.id_documento',
                            ...
                            DB::raw("concat((
                                case when tbl2.fecha_servidor < '2020-11-18' OR tbl2.fecha_servidor is null then (select rutas_anexos.url_visualizacion from rutas_anexos where rutas_anexos.tipo_operacion = 'DOCANT')
   ...
   /** Insertar Documentos Vehículo**/
    ...
    public function ApiVehiculosAct()
    {
        ...
        //$respuesta = DB::table('Vehiculos_Activos_API')->get();
        return Response::json($respuesta);
    }
    ...
    public function visor2($request)
    {
        ...
        if($primeras == 'https://engie.sharepoint.com' or $primeras1 == 'https://equans.sharepoint.com'){

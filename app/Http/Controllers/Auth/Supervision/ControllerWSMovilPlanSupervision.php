...
class ControllerWSMovilPlanSupervision extends Controller
{
    ...
    */
    public function getInfoOrdenIns(Request $request){
        ...
        $materiales = $this->getMateriales($esTp,$idOrden,$request->nodo);
        $manoObra = $this->getManoObra($esTp,$idOrden,$request->nodo);
        $fotos = $this->getFotosOp($esTp,$idOrden,$request->nodo);
    ...
    private function getFotosOp($esTp,$orden,$nodo){
    ...
    */
    ...
    private function getManoObra($esTp,$orden,$nodo){
        if($esTp){
    ...
    */
    ...
    private function getMateriales($esTp,$orden,$nodo){

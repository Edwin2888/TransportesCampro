...
function finalizarManoObra()
{
  if(confirm("¿Seguro que desea cerrar la orden?"))
  {
    ...
    var route = server + "updateOrdenEnd";
    $.ajax({
      url: route,
      type: "POST",
      dataType: "json",
...
function siguienteMaterailes()
{
  ...
  {
     window.location.href = "../finalizaAppProgramados"
  }
  else
  {

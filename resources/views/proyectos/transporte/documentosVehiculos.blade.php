...
<main>
@include('proyectos.transporte.modal.modalAgregarDocumento')
@include('proyectos.transporte.modal.modalLogDocumentosVehiculo')
...
<div class="container">
    ...
    <div class="row">
        <section>
            @include('proyectos.transporte.tables.tbldocumentosVehiculos')
        </section>
    </div>
</div>
</main>

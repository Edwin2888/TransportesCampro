...
<main>
    <!-- MODAL-->
    @include('proyectos.transporte.modal.modalIncidenciasDemo')    
                    ...
                    <div style="overflow-y:auto;height:100%;">
                      ...
                      <p class="texto-title"><b style="color:#0060AC">Estado conductores</b></p>
                        <select class="form-control" id="select_estado_conductores">
                          ...
                          <option value="E3">Con incidencia generada</option>
                          <option value="E2">Mantenimiento</option>
                          <option value="E1">Activo</option>
                        </select>
                      <hr style="margin:7px;border-color:#0060AC">

...
{!! Form::open(['url' => 'filterSeguimientoIncidencia', "method" => "POST"]) !!}
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    {!!Form::select('selTipoVehiculo', $tipoM, Session::get('selTipoVehiculo'), ["class"=>"form-control selectWzrd","placeholder"=>"Seleccione","id"=>"selTipoVehiculo"])!!}
                </div>
        </div>
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    <label for="id_orden">Estado:</label>
                        {!!Form::select('selEstado', $estadoM, Session::get('selEstado'), ["class"=>"form-control selectWzrd","placeholder"=>"Seleccione","id"=>"selEstado"])!!}
                </div>
        </div>
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    {!!Form::select('selProyectoCliente', $proy, Session::get('selProyectoCliente'), ["class"=>"form-control selectWzrd","placeholder"=>"Seleccione","id"=>"selProyectoCliente"])!!}
                    </select>
                </div>
        </div>
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txt_incidencia" id="txt_incidencia" class="form-control" value="{{Session::get('txt_incidencia')}}">
                </div>
        </div>
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    <label for="id_orden">Tipo de mantenimeinto:</label>
                    <select name="tipoMANTSelect" class="form-control" id="tipoMANTSelect">
                        <option value="">Seleccione</option>
                        @if(Session::has("tipoMANTSelect"))
                            @if(Session::get("tipoMANTSelect") == 1)
                                <option value="1" selected>Correctivo</option>
                                <option value="2">Preventivo</option>
                            @else
                                @if(Session::get("tipoMANTSelect") == "")
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txt_placa_filter" id="txt_placa_filter" class="form-control" value="{{Session::get('txt_placa_filter')}}">
                </div>
        </div>
        ...
        <div class="col-md-1">
         ...
         <div class="col-md-1">
            <a href="../../transversal/incidencias/home" class="btn btn-primary btn-cam-trans btn-sm" style="    margin-left: 0px;    margin-top: 23px;    left: -8%;    position: relative;"><i class="fa fa-times"></i> &nbsp; Regresar</a>
        </div>

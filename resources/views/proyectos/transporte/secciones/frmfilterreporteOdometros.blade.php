...
{!! Form::open(['url' => 'transversal/reporte/odometro/filter', "method" => "POST", "id" => "btn_consulta_datos"]) !!}
                    ...
                    <div class="input-group date form_date" data-date="" data-date-format="dd/mm/yyyy"
                        ...
                        @if(Session::has('fecha_inicio'))
                            ...
                            <input class="form-control" size="16" style="height:30px;" type="text"
                               ...
                               placeholder="dd/mm/aaaa" onBlur="valida_fecha(this.form);" required>
                        @else
                            <input class="form-control" size="16" style="height:30px;" type="text"
        ...
        <div class="col-md-2">
                <div class="form-group has-feedback">
                    ...
                    <input type="text" name="txt_placa" id="txt_placa" class="form-control" value="{{Session::get('txt_placa')}}">
                </div>
        </div>
        <div class="col-md-1">

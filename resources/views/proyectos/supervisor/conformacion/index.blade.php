...
@section('title')
	Conformación plan de supervisión
@stop
...
@section('content')
	...
	<main>
		...
		<div class="container-fluid">
            <div class="side-body" id="cuerpo" style="margin-top:20px;margin-left:0px;">
                @include('proyectos.supervisor.conformacion.frm.filterConformacionPlan') 
            </div>

            <div class="tbl_index_proyectos" id="tbl_index_proyectos" data-pos="0">
                @include('proyectos.supervisor.conformacion.tables.tablePlanSupervision')
            </div>
        </div>
	</main>
    ...
    <script type="text/javascript">
        ...
        function ini()
        {
            ...
            var altopx = alto+"px";
            $('#tbl_plan_supervision').dataTable({
                        "scrollX":  "100%",
                        "scrolY":   altopx,
                        "paging":   true,
                        "searching": true,

...
{!! Form::open(['url' => 'consultaFiltroSupervisor', "method" => "POST"]) !!}
                                                        ...
                                                        @else
                                                          ...
                                                          @else
                                                              @if(Session::get('tipo_inspeccion') == "36")
                                                                ...
                                                                <option value=44>Inspección Locativa de Gestión Ambiental</option>
                                                                <option value=46>Inspección Entrega Obras Civiles</option>
                                                                <option value=36 selected>Inspección Calidad Trabajos de Restablecimiento del Servicio</option>
                                                            @else
    ...
    {!!Form::close()!!}
        <div class="col-md-2">
            {!! Form::open(['url' => 'generateExcelIPALTest', "method" => "POST"]) !!}
            ...
            <button type="submit" onclick="generaConsolidado()" style="margin-top: 23px;" class="btn btn-primary  btn-cam-trans btn-sm" type="submit" name="consultar" value="consultar" onclick="consultaFiltro()">
                <i class="fa fa-file-excel-o"></i> &nbsp;&nbsp;Generar consolidados
            </button>
            {!!Form::close()!!}
        </div>

        <div class="col-md-2">
            <form action="{{config('app.Campro')[2]}}/campro/home/xls_nuestros_valores.php" method="POST" style="    border-bottom: 1px solid white;">


                <input type="hidden" name="fecha_iniciox" value="{{$fecha2}}" name="fecha_iniciox">
                <input type="hidden" name="fecha_finy" value="{{$fecha1}}" name="fecha_finy">


                <button  style="margin-top: 23px;" class="btn btn-primary  btn-cam-trans btn-sm"> <i class="fa fa-file-excel-o"></i>  Valores</button>

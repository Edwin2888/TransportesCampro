...
<div id="filter" class="collapse in" style="margin-top:9px;border: 1px solid #3b8bd0;    border-radius: 10px;" arial-expanded="true">
    ...
    {!! Form::open(['url' => 'filterganntRestriccion', "method" => "POST"]) !!}
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="form-group has-feedback">
                    <label for="id_orden">Responsable:</label>
    ...
    <div class="elementos">   
            <a href="../../restricciones" target="_blank"><span>1</span></a>         
            <a href="#"  style="background-color:#9e9e9e" ><span>2</span></a>         
            <a href="../../scrumRestricciones"  target="_blank"  ><span>3</span></a>         
    </div>

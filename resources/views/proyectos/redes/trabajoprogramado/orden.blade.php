...
*/ ?>    
    ...
    <div class="panel-body wbs">
            <div class="col-md-12">
                    ...
                    <div class="row">
                        <h5 style="text-align:center"><b>Recurso Técnico Seleccionado</b></h5>
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <p style="text-align:justify">
                 ...
                 <br>
                 <span class="badge" style="background-color:#0060AC !important">#</span> <b style="font-size:12px;color:#0060AC;">Cantidad de Actividades/Materiales programadas para la ejecución</b>
                 <br>
        ...
        @if($encabezado != null)
            <div class="col-md-8" style="display:block">
                <h4>Porcentaje de utlización cuadrillas - Día:<b id="fecha_programacion"></b></h4>
                <table>
                    <thead>
                        <tr>
                            <th style="text-align:center;">Tipo C.</th>
                            <th style="    width: 20%;text-align:center;">Líder</th>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-bottom:10px;">
                            <div class="input-group" style="width:270px;">
                                <label style="display:block">Filtrar por código:</label>
                                <input class="form-control" size="16" style="height:30px;display:inline-block;width:60%;" type="text"
                                                   value="" name="text_filter_cod_1" id="text_filter_cod_1" placeholder="Ingrese el código del baremo" required />
                                ...
                                <div id="home_recurso_1" class="tab-pane fade in active" style="display:none">
                                    ...
                                    <div class="row" style="margin-top:20px;">
                                      <div class="col-md-12">
                                        ...
                                        <label class="control-label col-md-5" for="inputSuccess3">Seleccionar a la líder de cuadrilla que se va a encargar de todo el nodo.</label>
                                            <div class="col-md-7">
                                ...
                                <div id="home_recurso_2" class="tab-pane fade in active" style="display:none">
                                    ...
                                    <div class="row" style="margin-top:20px;">
                                      ...
                                      <div class="col-md-12">
                                        ...
                                        <label class="control-label col-md-5" for="inputSuccess3">Seleccionar a la líder de cuadrilla que se va a encargar de la actividad.</label>
                                            <div class="col-md-7">
                                                  <div class="input-group">
                                                    <span class=" input-group-addon glyphicon glyphicon glyphicon-pencil" aria-hidden="true"></span>
            ...
            <div class="col-md-12">
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4" style="margin-bottom:10px;">
                            <div class="input-group" style="width:270px;">
                                <label style="display:block">Filtrar por clasificación:</label>
                        ...
                        <div class="col-md-4" style="margin-bottom:10px;">
                            <div class="input-group" style="width:270px;">
                                <label style="display:block">Filtrar por código:</label>
                                <input class="form-control" size="16" style="height:30px;display:inline-block;width:60%;" type="text"
                                                   value="" name="text_filter_cod_2" id="text_filter_cod_2" placeholder="Ingrese el código del material" required />
                      ...
                      <div class="panel-body">
                                <div id="home_material_1" class="tab-pane fade in active" style="display:none">
                                    ...
                                    <div class="row" style="margin-top:20px;">
                                      <div class="col-md-12">
                                        ...
                                        <label class="control-label col-md-5" for="inputSuccess3">Seleccionar a la líder de cuadrilla que se va a encargar de todo los materiales del nodo.</label>
                                            <div class="col-md-7"> 
                                                  <div class="input-group">
                                                    <span class=" input-group-addon glyphicon glyphicon glyphicon-pencil" aria-hidden="true"></span>
                                ...
                                <div id="home_material_2" class="tab-pane fade in active" style="display:none">
                                    ...
                                    <div class="row" style="margin-top:20px;">
                                      ...
                                      <div class="col-md-12">
                                        <div class="form-group has-feedback">
                                        <label class="control-label col-md-5" for="inputSuccess3">Seleccionar a la líder de cuadrilla que se va a encargar del material.</label>
                                            <div class="col-md-7">
                                                  <div class="input-group">
                                                    <span class=" input-group-addon glyphicon glyphicon glyphicon-pencil" aria-hidden="true"></span>
    ...
    <script type="text/javascript">
        ...
        function save_actividades()
        {
                ...
                {
                    mostrarModal(1,null,"Guardar ejecución","Ingrese por favor Solo un número de  preplanilla\n",0,"Aceptar","",null);
                    return;
                }
        ...
        function iniOrdenesTrabajoProgramadoAdd()
        {
            ...
            @if($encabezado[0]->id_estado == "E2" || $encabezado[0]->id_estado == "R0" || $encabezado[0]->id_estado == "PE" || $encabezado[0]->id_estado == "E4")
                ...
                document.querySelector("#btn_save_guardar_actividad").addEventListener("click",function()
                {
                    ...
                    if(document.querySelector("#preplanilla_id").value == "")
                    {
                        mostrarModal(1,null,"Guardar ejecución","No ha ingresado el consecutivo  de planilla\n",0,"Aceptar","",null);
                        return;
                    }
            ...
            @if($encabezado[0]->id_estado == "E1")
                document.querySelector("#btn_captura_finaliza").addEventListener("click",function()
                {
                    ...
                    {
                        mostrarModal(1,null,"ManiObra","No puede finalizar la programación de la maniobra, por que no ha seleccionado ningún nodo.\n",0,"Aceptar","",null);
                        return;
                    }
                    var datos = 
                    {
            ...
            {////////////
                ...
                if(confirm("¿Seguro que desea finalizar la programación?"))
                {
                    var datos = 
                    {
                        opc : "3",
            ...
            @else
                ...
                document.querySelector("#btn_save_restriccion").addEventListener("click",function()
                {
                    ...
                    {
                        mostrarModal(1,null,"Agregar restricción","No ha ingresado ningún responsable.\n",0,"Aceptar","",null);
                        return;
                    }
                     ...
                     $.ajax({
                        ...
                        // timeout:tiempoEspera,
                         ...
                         error: function(data, textStatus) {  
                              mostrarModal(1,null,"Ocurrio un error","Por favor inténtalo nuevamente más tarde.\n",0,"Aceptar","",null);
                            return;
                         }
                     }).always(function() { 
        ...
        function consultaPorcentaProduccion()//PORCENTA DE PRODUCCIÖN
        {
        ...
        function addNodosSelect(ele)
        {
            ...
            if(tbl.length == 0)
            {
                mostrarModal(1,null,"Agregar nodos","No ha seleccionado ningún nodo.\n",0,"Aceptar","",null);
                return;
            }
        ...
        function saveNodos()
        {
            ...
            var personaACargo = [];
            nodosSelecArray = [];
            if(nodes.nodes.length > 0) //Tiene más de un hijo
            {
        ...
        function saveNodosBaremos()
        {
            ...
            //Recorrer arreglos de nodos para guardar la información
            ...
            $('#treeview9').treeview({
                      ...
                      onNodeUnselected: function(event,data)
                      {
                        ...
                        if(tipo == "B")
                        {
                            ...
                            {
                                document.querySelector("#nombre-plan").innerHTML = "BAREMO: Más de 1 Baremo seleccionado";
    ...
    <script type="text/javascript">
        ...
        function abrirModalDatos(lider,auxX,horaIn,horaFn,tipo)
        {
            ...
            if(tip == 5)
            {
                document.querySelector("#text_iden_recurs").innerHTML = "Matrícula";
        ...
        {
            if(confirm("¿Seguro que desea eliminar el líder?"))
            {
                var datos = 
                {
                    opc : 6,
        ...
        function saveDatosOrden()
        {
            ...
            @if($tipoProyecto == "T02")
                ...
                /* Hora inicio -  Días Lunes y viernes - Mínimo 09:00
                var horas = horaIni.split(":");
                if(diaTexto == "Lunes" || diaTexto == "Viernes")
                {
                    if(parseInt(horas[0]) < 9)
                    {
                        mostrarModal(1,null,"ManiObra","La hora de inicio de la Maniobra tiene que ser igual ó mayor a las 9:00am - " + diaTexto + " .\n",0,"Aceptar","",null);
                        return;
                    }
                }

                // Hora inicio -  Días Martes, Miercoles, Jueves , Sábado y Domingo - Mínimo 08:00
                if(diaTexto == "Domingo" || diaTexto == "Martes" || diaTexto == "Miércoles" || diaTexto == "Jueves" || diaTexto == "Sábado")
                {
                    if(parseInt(horas[0]) < 8)
                    {
                        mostrarModal(1,null,"ManiObra","La hora de inicio de la Maniobra tiene que ser igual ó mayor a las 8:00am -  " + diaTexto + ".\n",0,"Aceptar","",null);
                        return;
                    }   
                }

                // Hora de corte -  Validar que no existan más de una Maniobra de División electrica
            ...
            /*if (Fecha2 < Fecha1){
                ...
                if (Fecha2 < Fecha1){
                    mostrarModal(1,null,"ManiObra","La fecha de fin de ejecución de la Maniobra, no puede ser menor a la fecha de inicio de ejecución\n",0,"Aceptar","",null);
                    return;  
                }
...
//sssss
               ...
               // timeout:tiempoEspera,
                success:function(data)
                {
                    if(opcion == 1)
                    {
                        ...
                        if(data == -7)
                        {
                            mostrarModal(1,null,"ORDEN","No puede guardar la ManiObra, por que ya existen más de 3 ordenes con la misma hora de corte .\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                        ...
                        else
                        {
                            if(data.length > 4)
                            {
                                mostrarModal(1,null,"Consulta CD","Uno ó varios de los CD, PF ó SECCIONADOR que ingreso tuvo una intervención menor a 9 días, tiene problemas con los siguientes datos: \n" + data,0,"Aceptar","",null);
                                document.querySelector("#text_cd").value = "";
                                ocultarSincronizacion();
                                return;
                            }
                    ...
                    if(opcion == 7) //Nuevo elemento
                    {
                        if(data == "-2")
                        {
                            mostrarModal(1,null,"Ejecución orden","No se puede programar la orden, por que no ha asociado actividades o materiales a la maniobra.\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                        ...
                        if(data.res == "-1")
                        {
                            ...
                            for (var i = 0; i < data.restriccion.length; i++) {
                                html += " - <b>TIPO:</b> " + data.restriccion[i].tipoR + "   <b>DESCRIPCIÓN:</b> " + data.restriccion[i].restriccion_descripcion + "     <b>FECHA LÍMITE:</b>" + data.restriccion[i].fecha_limite.split(" ")[0] + "       <b>RESPONSABLE:</b>" + data.restriccion[i].responsable + "<br>"; 
                            };


                            mostrarModal(1,null,"Ejecución orden","No se puede programar la orden, por que las siguiente restricciones son obligatorias y no han sido levantadas <br>\n " + html,0,"Aceptar","",null);
                        ...
                        mostrarModal(2,null,"Ejecución orden","Se ha programado correctamente la ManiObra.\n",0,"Aceptar","",null);
                        window.location.reload();   
                    }
                    ...
                    {   
                        ...
                        {
                            ocultarSincronizacion();
                            mostrarModal(1,null,"Cambio de líder","No puede hacer el cambio del líder, por que el líder actual tiene DC confirmados.\n",0,"Aceptar","",null);
                            return;
                        }
                        ...
                        {
                            ocultarSincronizacion();
                            mostrarModal(1,null,"Cambio de líder","No puede hacer el cambio del líder, por que el líder actual tiene ejecución de actividades.\n",0,"Aceptar","",null);
                            return;
                        }
                    ...
                    if(opcion == 13)
                    {
                        ...
                        {
                            ocultarSincronizacion();
                            mostrarModal(1,null,"ManiObra","No se puede eliminar el líder, por que tiene asociados uno o varios  DC con estado confirmado.\n",0,"Aceptar","",null);
                            return;
                        }
                        ...
                        {
                            ocultarSincronizacion();
                            mostrarModal(1,null,"ManiObra","No puede eliminar al líder.\n",0,"Aceptar","",null);
                            return;
                        }
                        ...
                        {
                            ocultarSincronizacion();
                            mostrarModal(1,null,"ManiObra","No puede eliminar al líder, por que tiene ejecución de actividades.\n",0,"Aceptar","",null);
                            return;
                        }
                    ...
                    if(opcion == 29) //Finalizar Orden Ejecución
                    {
                        if(data == "1")
                        {
                    ...
                    if(opcion == 30) //Consultar GOM por WBS
                    {
                        ...
                        if(data == "-1")
                        {
                            mostrarModal(1,null,"Asignar GOM","No ha ingresado ninguna restricción para la ManiObra\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                    ...
                    if(opcion == 33) //Consulta Nodos Afectado Conciliación
                    {
                    ...
                    if(opcion == 37) //Reprogramación de Maniobra
                    {
                        if(data == "-4")
                        {
                            mostrarModal(1,null,"Re programación de Maniobra","Se presento un problema desconocido, por favor vuelva a intentarlo.\n",0,"Aceptar","",null);
                            setTimeout(function()
                            {
                               location.reload();
                            },2000);
                        ...
                        if(data == "-3")
                        {
                            mostrarModal(1,null,"Re programación de Maniobra","La fecha de reprogramación de ManiObra no puede ser igual a la fecha de ejecución de la Maniobra.\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                        ...
                        if(data == "-2")
                        {
                            mostrarModal(1,null,"Re programación de Maniobra","La Maniobra actual se encuentra con CAMPROS no anulados.\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                        ...
                        if(data == "-1")
                        {
                            mostrarModal(1,null,"Re programación de Maniobra","La fecha de re programación de la ManiObra no puede ser menor o igual a la actual.\n",0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }
                        ...
                        if(data.length > 10)
                        {
                            mostrarModal(1,null,"Re programación de Maniobra","Los siguientes líderes tiene asignadas ManiObras para la fecha que seleccion de re programación:\n" + data,0,"Aceptar","",null);
                            ocultarSincronizacion();
                            return;
                        }

                        mostrarModal(2,null,"Re programación de Maniobra","Se ha re programado correctamente la ManiObra",0,"Aceptar","",null);
                        setTimeout(function()
                        {
                           location.reload();
                        },2000);
                    ...
                    if(opcion == 39) //Consulta DC Asociados
                    {
                        ...
                        else
                        {
                            ...
                            if(hijosNodosTbl.length == 1)
                            {
                                ...
                                {
                                    mostrarModal(1,null,"Asignación DC","No tiene nodos seleccioandos para este ManiObra.\n",0,"Aceptar","",null);
                                    ocultarSincronizacion();
                                    return;
                                }
                            }
                    ...
                    if(opcion == 40) //Asigna DC a líder
                    {
                        ocultarSincronizacion();
                        if(data == 1)
                        {
                            mostrarModal(2,null,"Asignación DC","Se la asignado correctamente el despacho al líder.\n",0,"Aceptar","",null);
                            setTimeout(function()
                            {
                                location.reload();
                            },1000);
                        ...
                        if(data == 0)
                        {
                            mostrarModal(1,null,"Asignación DC","No se pudo asignar el despacho al líder.\n",0,"Aceptar","",null);
                            
                        }

                        if(data == -1)
                        {
                            mostrarModal(1,null,"Asignación DC","El DC ya fue asignado a otro líder.\n",0,"Aceptar","",null);
                            setTimeout(function()
                            {
                                location.reload();
                            },1000);
                        ...
                        if(data.length > 3)
                        {
                            mostrarModal(3,null,"Asignación DC","Se presentaron los siguiente problemas al asignar el DC. \n\n" + data,0,"Aceptar","",null);
                            setTimeout(function()
                            {
                                location.reload();
                            },3000);
                    ...
                    if(opcion == 41) //Consulta Líder cambio
                    {
                        var html = "";
                        html += "<option value=''>Todos";
                        html += "</option>";
                    ...
                    if(opcion == 42) //Consulta Producción cuadrilla
                    {
                    ...
                    if(opcion == 47) //Consulta CD ya trabajo < 9 días
                    {
                        if(data != "")
                        {
                            mostrarModal(1,null,"Consulta CD","Uno ó varios de los CD, PF ó SECCIONADOR que ingreso tuvo una intervención menor a 9 días, tiene problemas con los siguientes datos: \n" + data,0,"Aceptar","",null);
        ...
        function consultaMaterialAdd()
        {
            if(document.querySelector("#text_mate_search").value == "" &&
                document.querySelector("#text_mate_des_seacrh").value == "")
            {
                mostrarModal(1,null,"Filtro Materiales","Ingrese información para el filtro\n",0,"Aceptar","",null);
        ...
        function agregarPersona1()
        {
            ...
            {
                if(confirm("¿Seguro que desea cambiar el líder actual?"))
                {
        ...
        function seleccionarDCLider()
        {
            ...
            if(cont == 0)
            {
                mostrarModal(1,null,"Asociar DC","No ha seleccionando ningún DC para asociar al líder\n",0,"Aceptar","",null);
                return;
            }
            ...
            if(confirm("¿Seguro que desea asignar los DC seleccionados al líder?"))
            {
                var arr = [];
                 for (var i = 0; i < hi.length; i++) {
                    if(hi[i].children[0].children[0].checked)
        ...
        function save_responsable_restriccion()
        {
            if(document.querySelector("#txt_nombre_resp_create").value == "" ||
                document.querySelector("#txt_nombre_resp_email").value == "" )
            {
                mostrarModal(1,null,"Agregar responsable","Hace falta diligenciar información\n",0,"Aceptar","",null);
                return;
            }
        ...
        function agregarReponsableNuevo()
        {
            ...
            {
                mostrarModal(1,null,"Agregar responsable","No ha seleccionado ningún responsable\n",0,"Aceptar","",null);
                return;
            }
                       ...
                       $.ajax({
                              ...
                              success: function(data) {PNotify.removeAll();
                                      if(data.result == 1){
                                              ...
                                              mensajes("Error",data.response.message,0); 
                                      }else{ mensajes("Error","Ocurrió un error por favor inténtalo nuevamente mas tarde.",0); }
                              }, 
                              error: function(){  PNotify.removeAll(); mensajes("Error","Ocurrió un error por favor inténtalo nuevamente mas tarde.",0);   }
                      }).always(function(){      
